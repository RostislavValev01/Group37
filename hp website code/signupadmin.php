...
if (isset($_POST["submit"])) {
    ...
    // Get the maximum AdminID currently in the table
    $result = mysqli_query($con, "SELECT MAX(Admin_ID) AS max_id FROM accountdetails");
    $row = mysqli_fetch_assoc($result);
    $max_id = $row['max_id'];

    // Calculate the next AdminID in the database
    $next_id = $max_id + 1;
    ...
    if (mysqli_num_rows($verify_query) !=0) {
        ...
        if ($refkey === $admin_reference_key) {
            ...
            mysqli_query($con, "INSERT INTO accountdetails(FirstName, Surname, MobileNumber, Email, Password, CustomerAddress, DateOfBirth, Admin_ID, AdminStatus) VALUES('$fname', '$surname', '$mnumber', '$email', '$password', '$address', '$dob', '$next_id', 1)" ) or die("Error Occured");
            echo "<div class='message'>
    ...
    <div class="content">
        <table class="registration-table">
            ...
            <tr>
                ...
                <td>
                    <input type="text" id="mnumber" name="mnumber" placeholder="Mobile Number" required><br><br>
                </td>
            </tr>
            <tr>
                <td>
