...
let first_firstname = document.getElementById("newFirstName");
let first_surname = document.getElementById("newLastName");
let first_email = document.getElementById("newEmail");
let first_pass = document.getElementById("newPassword");
let first_number = document.getElementById("newMobile");
